...
/* harmony import */ var _fieldStore__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(6);
/* harmony import */ var _utils_common__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);
...
Form.create = function () {
  ...
  return function (WrappedComponent) {
    ...
    return _temp = /*#__PURE__*/function (_React$Component2) {
      ...
      function _temp() {
        ...
        _defineProperty(_assertThisInitialized(_this), "getFieldDecorator", function (key) {
          var config = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {
            rules: [],
            initialValue: initialValue
          };
          if (!key) throw Error("getFieldDecorator Error: lost formItem key");
          var rules = _this.fieldStore.rules;
          var store = _this.fieldStore.store;
          var initialMata = _this.fieldStore.initialMata;

          if (rules[key] === undefined || rules[key].length && !Object(_utils_common__WEBPACK_IMPORTED_MODULE_2__["comparisonObject"])(rules[key][0], config.rules[0])) {
            _this.fieldStore.dispatchRules(key, config.rules);
          }

          if (!(key in initialMata)) {
            _this.fieldStore.dispatchInitialMeta(key, config.initialValue);
          }
          ...
          return function (ComponentF) {
            var _onChange = function onChange(v) {
              ...
              _this.fieldStore.dispatchStore(key, type === "[object Object]" ? v.target.value || v.target.checked : v);

              _this.forceUpdate();
            };

            var propsNew = _objectSpread(_objectSpread({}, ComponentF.props), {}, {
            ...
            if (scrollIntoView) {
              propsNew.id = "".concat(key, "ByGetFieldDecorator");
            }

            var newTree = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.cloneElement(ComponentF, propsNew, ComponentF.props.children);
            return newTree;
          };
        });

        _defineProperty(_assertThisInitialized(_this), "validateFieldsWraped", function (submit) {
          if (_this.state.submitting) return;

          _this.fieldStore.validateFields(function (errMess, store) {
            if (scrollIntoView) {
              return document.querySelector("#".concat(errKey, "ByGetFieldDecorator")).scrollIntoView({
                block: "center",
                behavior: "smooth"
              });
            }
        ...
        _defineProperty(_assertThisInitialized(_this), "submitting", function () {
          return Boolean(_this.state.submitting);
        });

        _defineProperty(_assertThisInitialized(_this), "addtionaProps", function () {
          return {
            getFieldDecorator: _this.getFieldDecorator,
            setFieldsValue: _this.fieldStore.setFieldsValue,
            getFieldValue: _this.fieldStore.getFieldValue,
            validateFields: _this.validateFieldsWraped,
            resetFields: _this.fieldStore.resetFields,
            store: _this.fieldStore.store,
            submitting: _this.submitting()
          };
        });

        _this.state = {};
        _this.fieldStore = Object(_fieldStore__WEBPACK_IMPORTED_MODULE_1__["default"])();
        return _this;
      }
      ...
      _createClass(_temp, [{
        ...
        value: function render() {
          var props = {
            form: this.addtionaProps()
          };
          return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(WrappedComponent, _extends({}, this.props, props));
        }
      }]);
 ...
 * 表单仓库
 */
var FieldStore = function FieldStore(_fields) {
  var _this = this;

  _classCallCheck(this, FieldStore);

  _defineProperty(this, "dispatchStore", function (key, value) {
    _this.store[key] = value;
  });

  _defineProperty(this, "dispatchInitialMeta", function (key, value) {
    _this.initialMata[key] = value;
  });

  _defineProperty(this, "dispatchRules", function (key, rule) {
    _this.rules[key] = rule;
  });

  _defineProperty(this, "getFieldValue", function (key) {
    return _this.store[key] || _this.initialMata[key];
  });

  _defineProperty(this, "setFieldsValue", function (props) {
    _this.store = _objectSpread(_objectSpread({}, _this.store), props);
  });

  _defineProperty(this, "resetFields", function () {
    _this.store = _objectSpread({}, fields);
    _this.rules = {};
    _this.initialMata = {};
  });

  _defineProperty(this, "validateFields", function (submitting) {
    var errFlag = false,
        errMessage = "",
        errKey = "",
        rules = _this.rules;
  ...
  this.store = _objectSpread({}, _fields);
  this.rules = {};
  this.initialMata = {};
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "comparisonObject", function() { return comparisonObject; });
...
function comparisonObject(sourceObj, compareObj) {
  ...
  if (sourceType !== getType(compareObj)) return false; // Not objects and arrays
